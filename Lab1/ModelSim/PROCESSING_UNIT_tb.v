// -------------------------------------------------------------
// 
// File Name: hdlsrc\lab1_1\PROCESSING_UNIT_tb.v
// Created: 2022-10-09 18:56:15
// 
...
module PROCESSING_UNIT_tb;
  ...
  reg [19:0] Data_Type_Conversion8_out1_addr;  // ufix20
  ...
  wire Data_Type_Conversion8_out1_active;  // ufix1
  wire Data_Type_Conversion8_out1_enb;  // ufix1
  wire [19:0] Data_Type_Conversion8_out1_addr_delay_1;  // ufix20
  ...
  assign #1 Data_Type_Conversion7_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion6_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion5_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion4_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion3_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion2_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign #1 Data_Type_Conversion1_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  assign Data_Type_Conversion8_out1_active = Data_Type_Conversion8_out1_addr != 20'b11110100001001000000;



  assign Data_Type_Conversion8_out1_enb = Data_Type_Conversion8_out1_active & (rdEnb & tb_enb_delay);
  ...
  always @(posedge i_CLK or negedge i_RST_N)
    begin : DataTypeConversion8_process
      if (i_RST_N == 1'b0) begin
        Data_Type_Conversion8_out1_addr <= 20'b00000000000000000000;
      end
      else begin
        if (Data_Type_Conversion8_out1_enb) begin
          if (Data_Type_Conversion8_out1_addr >= 20'b11110100001001000000) begin
            Data_Type_Conversion8_out1_addr <= 20'b00000000000000000000;
          end
          else begin
            Data_Type_Conversion8_out1_addr <= Data_Type_Conversion8_out1_addr + 20'b00000000000000000001;
          end
        end
      end
    end
  ...
  assign #1 Data_Type_Conversion8_out1_addr_delay_1 = Data_Type_Conversion8_out1_addr;
  ...
  always @(Data_Type_Conversion8_out1_addr_delay_1, rdEnb, tb_enb_delay)
    begin
      if (tb_enb_delay == 0) begin
        rawData_i_W0 <= 8'bx;
      end
  ...
  // holdData reg for Data_Type_Conversion8_out1
  always @(posedge i_CLK or negedge i_RST_N)
    begin : stimuli_Data_Type_Conversion8_out1
      if (!i_RST_N) begin
        holdData_i_W0 <= 8'bx;
      end
      else begin
  ...
  always @(rawData_i_W0 or rdEnb)
    begin : stimuli_Data_Type_Conversion8_out1_1
      if (rdEnb == 1'b0) begin
