// -------------------------------------------------------------
// 
// File Name: hdlsrc\lab1_1\PROCESSING_UNIT.v
// Created: 2022-10-09 18:55:27
// 
...
// Source Path: lab1_1/PROCESSING_UNIT
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module PROCESSING_UNIT
  ...
  wire signed [15:0] Add1_stage2_add_temp;  // sfix16
  wire signed [16:0] Add1_op_stage1;  // sfix17
  reg signed [7:0] Unit_Delay6_out1;  // int8
  wire signed [15:0] Product2_out1;  // int16
  wire signed [15:0] Add1_stage3_add_cast;  // sfix16
  wire signed [15:0] Add1_stage3_add_temp;  // sfix16
  wire signed [17:0] Add1_op_stage2;  // sfix18
  reg signed [7:0] Unit_Delay7_out1;  // int8
  wire signed [15:0] Product3_out1;  // int16
  wire signed [15:0] Add1_stage4_add_cast;  // sfix16
  ...
  assign Product4_out1 = Unit_Delay_out1 * Unit_Delay4_out1;
  ...
  assign Add1_stage2_add_temp = Product4_out1 + Product1_out1;
  assign Add1_op_stage1 = {Add1_stage2_add_temp[15], Add1_stage2_add_temp};
  ...
  assign Add1_stage3_add_cast = Add1_op_stage1[15:0];
  assign Add1_stage3_add_temp = Add1_stage3_add_cast + Product2_out1;
  assign Add1_op_stage2 = {{2{Add1_stage3_add_temp[15]}}, Add1_stage3_add_temp};
  ...
  assign Add1_stage4_add_cast = Add1_op_stage2[15:0];
  assign Add1_out1 = Add1_stage4_add_cast + Product3_out1;
