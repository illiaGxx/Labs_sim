// -------------------------------------------------------------
// 
// File Name: D:\Matlab_Projects\Labs\Lab2\lab2_01\CALC_MAGNITUDE_AND_PHASE_FIXED_POINT.v
...
// Source Path: lab2_01/CALC_MAGNITUDE_AND_PHASE_FIXED_POINT
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module CALC_MAGNITUDE_AND_PHASE_FIXED_POINT
  ...
  input   clk_enable;
  input   i_VALID;
  input   signed [31:0] i_COMPLEX_VALUE_re;  // sfix32_En29
  input   signed [31:0] i_COMPLEX_VALUE_im;  // sfix32_En29
  output  ce_out;
  output  o_VALID;
  output  signed [32:0] o_MAGNITUDE;  // sfix33_En29
  ...
  wire i_VALID_1;
  wire signed [63:0] Product_out1;  // sfix64_En58
  wire signed [63:0] Product1_out1;  // sfix64_En58
  wire signed [63:0] Add_out1;  // sfix64_En58
  wire signed [32:0] Sqrt_out1;  // sfix33_En29
  ...
  Sqrt u_Sqrt (.clk(clk),
               .reset(reset),
               .enb(clk_enable),
               .din(Add_out1),  // sfix64_En58
               .dout(Sqrt_out1)  // sfix33_En29
               );
  ...
  atan2_cordic_nw u_Atan2_inst (.clk(clk),
                                .reset(reset),
                                .enb(clk_enable),
                                .y_in(i_COMPLEX_VALUE_im),  // sfix32_En29
                                .x_in(i_COMPLEX_VALUE_re),  // sfix32_En29
                                .angle(Atan2_out1)  // sfix32_En29
                                );

  assign Data_Type_Conversion_out1 = Atan2_out1[31:16] + $signed({1'b0, Atan2_out1[15] & (( ~ Atan2_out1[31]) | (|Atan2_out1[14:0]))});
