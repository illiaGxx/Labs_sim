// -------------------------------------------------------------
// 
// File Name: D:\Matlab_Projects\Labs\Lab2\lab2_01\CALC_MAGNITUDE_AND_PHASE_FIXED_POINT_tb.v
// Created: 2022-11-27 19:43:12
// 
...
module CALC_MAGNITUDE_AND_PHASE_FIXED_POINT_tb;
  ...
  reg signed [31:0] rawData_i_COMPLEX_VALUE_im;  // sfix32_En29
  reg signed [31:0] status_i_COMPLEX_VALUE_im;  // sfix32
  reg signed [31:0] holdData_i_COMPLEX_VALUE_im;  // sfix32_En29
  reg signed [31:0] i_COMPLEX_VALUE_im_offset;  // sfix32_En29
  wire signed [31:0] i_COMPLEX_VALUE_im;  // sfix32_En29
  ...
  reg signed [31:0] rawData_i_COMPLEX_VALUE_re;  // sfix32_En29
  reg signed [31:0] status_i_COMPLEX_VALUE_re;  // sfix32
  reg signed [31:0] holdData_i_COMPLEX_VALUE_re;  // sfix32_En29
  reg signed [31:0] i_COMPLEX_VALUE_re_offset;  // sfix32_En29
  wire signed [31:0] i_COMPLEX_VALUE_re;  // sfix32_En29
  ...
  wire ce_out;
  wire o_VALID;
  wire signed [32:0] o_MAGNITUDE;  // sfix33_En29
  ...
  wire signed [32:0] o_MAGNITUDE_expected_1;  // sfix33_En29
  wire signed [32:0] o_MAGNITUDE_ref;  // sfix33_En29
  ...
  CALC_MAGNITUDE_AND_PHASE_FIXED_POINT u_CALC_MAGNITUDE_AND_PHASE_FIXED_POINT (.clk(clk),
                                                                               ...
                                                                               .i_VALID(i_VALID_1),
                                                                               .i_COMPLEX_VALUE_re(i_COMPLEX_VALUE_re),  // sfix32_En29
                                                                               .i_COMPLEX_VALUE_im(i_COMPLEX_VALUE_im),  // sfix32_En29
                                                                               .ce_out(ce_out),
                                                                               .o_VALID(o_VALID),
                                                                               .o_MAGNITUDE(o_MAGNITUDE),  // sfix33_En29
